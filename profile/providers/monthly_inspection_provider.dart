...
import 'return_vehicle_providers.dart';

final monthlyInspectionProvider =
    NotifierProvider.autoDispose<MonthlyInspectionNotifier, bool>(MonthlyInspectionNotifier.new);
