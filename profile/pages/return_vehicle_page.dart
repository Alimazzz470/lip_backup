...
import '../providers/return_vehicle_providers.dart';

class ReturnVehiclePage extends ConsumerWidget {
  final String vehicleId;

  const ReturnVehiclePage({
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final isLoading = ref.watch(submitInspectionProvider);
    return Loader(
      isLoading: isLoading,
      child: Scaffold(
        appBar: AppBar(
          title: Text(
            LocaleKeys.return_vehicle.tr(),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Consumer(
                  builder: (_, ref, __) {
                    final inspectionImages = ref.watch(setInspectionImagesProvider);
                    return Wrap(
                      runSpacing: 14.w,
                      spacing: 12.w,
                      children: inspectionImages.map((e) {
                        return _UploadImage(
                          ...
                          onRemove: () {
                            ref.read(setInspectionImagesProvider.notifier).removeImage(e.type);
                          },
                        );
                      }).toList(),
                    );
                ...
                Consumer(
                  builder: (_, ref, __) {
                    ...
                    final isDisable = totalTraveled == null ||
                        ...
                        inspectionImages.any((element) => element.selectedImagePath == null);
                        ...
                        showBottomModal(
                          ...
                          child: SignatureView(
                            onSigned: (bytes) {
                              ...
                              ref.read(submitInspectionProvider.notifier).submit(
                                  ...
                                  onSuccess: () {
                                    ...
                                    showSuccessSnackBar(
                                      context,
                                      message: LocaleKeys.success_verification_send.tr(),
                                    );
                                  },
                                  onError: () {
                                    showErrorSnackBar(
